...
class Rat_Game:
    ...
    def game_step(self, action):
        ...
        if action[3] == 1:
            if self.grid.is_valid_position(self.player.x + 1, self.player.y + 1):
                self.grid.clear_player_position()
        ...
        self.grid.draw_grid(self.screen) # Renderiza o grid em self.screen 
...
class Grid:
    ...
    def __init__(self, player, n_rows = 10, n_cols = 10, screen_width = 500, screen_height = 500):
        ...
        # Dimensoes do retangulo (representando cada cell do grid) a ser desenhado
    ...
    def draw_grid(self, screen):
        """Funcao de renderizacao do grid. TODO: Mover este metodo para a classe Rat_Game; a unica responsabilidade de Grid deveria ser armazenacao e atualizacao de estado."""
    ...
    def update(self):
        ...
        if self.frame_iteration > 20: # Se foram realizados 20 steps
            self.done = True          # Jogo encerrado
